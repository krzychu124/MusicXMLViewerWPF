...
namespace MusicXMLScore.LayoutControl
{
    class MeasureSegmentController
    {
        ...
        public MeasureSegmentController(Model.ScorePartwisePartMeasureMusicXML measure, string partID)
        {
            ...
            segmentPanel.AddAttributesContainer(new SegmentPanelContainers.MeasureAttributesContainer(measure.Items.OfType<Model.MeasureItems.AttributesMusicXML>().FirstOrDefault()));
        }
